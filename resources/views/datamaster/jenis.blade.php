        ...
        <div class="card shadow mb-4">
            <div class="card-header py-3 d-flex">
                ...
                <div class="ml-auto p-2 bd-highlight">
                    ...
                    @include('datamaster.modal_create.Cjenis')


                    @include('datamaster.modal_edit.Ejenis')
                </div>
            </div>
            <div class="card-body">
