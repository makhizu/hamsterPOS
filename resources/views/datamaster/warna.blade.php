...
@section('content')
    ...
    <div class="container-fluid">
        ...
        <!-- Page Heading -->
        <h1 class="h3 mb-2 text-gray-800">Warna</h1>
        @if ($errors->any())
        ...
        <div class="card shadow mb-4">
            <div class="card-header py-3 d-flex">
                ...
                <div class="ml-auto p-2 bd-highlight">
                    ...
                    @include('datamaster.modal_create.Cwarna')
